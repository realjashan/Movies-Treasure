...
// //search logic by filtering//
// useEffect(() => {
//     db.collection('movies').onSnapshot(snapshot => {
//         setResults(snapshot.docs.map((doc) => doc.data()))
//     })

//     //got all data in results//
...
//         <SearchInput value={search} onChangeText={(text)=>setSearch(text) } placeholderTextColor='#7f7f7f' placeholder='Search for movie,drama,series,etc..'/>
//     <TouchableOpacity>
